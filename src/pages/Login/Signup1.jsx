			...
			<LoginContainer>
				...
				<LoginContent>
					<div className="login1Title_wrapper">
						<div className="login1Title_left_wrapper">
							<p id="login1_title_text">이용약관</p>
							<p id="login1_subtitle">
								서비스 이용을 위해 이용약관 동의가 필요합니다.
							</p>
						</div>
						<div className="login1Title_right_wrapper">
							<div className="login1Title_right_step_wrapper">
					...
					<div className="content">
						...
						<div className="termUse_container">
							<div className="termUse_title_wrapper">
								<p id="termUse_title">이용약관 (필수)</p>
								<div className="detailShow_wrapper">
									<p>내용보기</p>
									<img
										src="/icon/join/right_arrow.png"
										alt="내용보기"
										className="detailShow_arrow"
									/>
								</div>
							</div>
						...
						<div className="personalInfo_container">
							<div className="personalInfo_title_wrapper">
								<p id="personalInfo_title">개인정보 수집 및 필수 동의 (필수)</p>
								<div className="detailShow_wrapper">
									<p>내용보기</p>
									<img
										src="/icon/join/right_arrow.png"
